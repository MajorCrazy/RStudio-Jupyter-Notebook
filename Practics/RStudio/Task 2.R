...
summary(t_critical) #t = 2.048
# ЧСС = DF(32) - Число строк(4) = 28


#I(qsec^2)(Estimate) = 0.023, I(qsec^2)(Std. Error) = 0.006
#Доверительный интервал: [0.023 - 2.048 * 0.006, 0.023 + 2.048 * 0.006]
#[0.010712, 0.035288]

#I(drat^2)(Estimate) = 0.691, I(drat^2)(Std, Error) = 0.119
#Доверительный интервал: [0.691 - 2.048 * 0.119, 0.691 + 2.048 * 0.119]
#[0.447288, 0,934712]

#wt_drat(Estimate) = -1.332, wt_drat(Std. Error) = 0.187
#Доверительный интервал: [-1.332 - 2.048 * 0.187, -1.332 + 2.048 * 0.187]
#[-1.714976, -0.949024]
